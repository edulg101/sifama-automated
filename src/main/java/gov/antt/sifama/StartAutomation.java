...
//        inicioDigitacao();
    ...
    @Transactional
    public boolean inicioDigitacao() throws InterruptedException {
...
//        consulta.changeValueInSelectByTexts(idTipoOcorrencia, "VII - deixar meios-fios danificados, deteriorados ou ausentes por prazo superior a 72 (setenta e duas) horas, ou conforme prazo diverso previsto no");
